export const TEAM_MEMBERS = [
  ...
  {
    id: 'khushal',
    name: 'Khushal Pappula',
    role: 'Member',
    initials: 'KP',
    tags: ['Collaborative research'],
    bio: 'Khushal is a member of Collaborative Research Club, contributing to shared research projects alongside his peers — from literature review and experiments through analysis and write-up.',
  },
  {
    id: 'nihar',
    ...
    initials: 'NM',
    tags: ['Collaborative research'],
    bio: 'Nihar is a member of Collaborative Research Club, working with the lab on student-led research and the collaborative workflows that keep projects moving from question to write-up.',
  },
  {
    id: 'rithvik-boyapati',
    ...
    initials: 'RB',
    tags: ['Collaborative research'],
    bio: 'Rithvik is a member of Collaborative Research Club, contributing to peer-led research projects and the day-to-day work of literature review, experiments, and analysis.',
  },
  {
    id: 'sampreet',
    name: 'Sampreet Kottakota',
    role: 'Member',
    initials: 'SK',
    tags: ['Collaborative research'],
    bio: 'Sampreet is a member of Collaborative Research Club, collaborating with the team on shared research projects and helping turn student-led inquiry into rigorous write-ups.',
  },
]
